...
The backend architecture features an ASP.NET Core API utilizing Entity Framework and ASP.NET Identityn. To ensure instantaneous state updates, SignalR. 
Built a full-stack IoT ecosystem centered on a Python-based Raspberry Pi charging prototype. 
The ecosystem is tied together by an Avalonia-based frontend.
